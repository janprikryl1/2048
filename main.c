...
int main()
{
    ...
    while (!quit) // Projdu všechny události (z klávesnice, myši) a zpracuju je. Poté jdu dál
    {
                ...
                switch( e.key.keysym.sym ){
                    case SDLK_LEFT:                        
                        if (game_mode == 1) {
                            ...
                            for (int r = 0; r < 8; r++)
                            {
                                if (pole_2[r][0] && (pole_2[r][0] == pole_2[r][1])){
                                    if (pole_2[r][0]*2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }                                    
                                    pole_2[r][0] = pole_2[r][0]*2;
                                    pole_2[r][1] = 0;
                                }
                                if (pole_2[r][1] && (pole_2[r][1] == pole_2[r][2])) {
                                    if (pole_2[r][1] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[r][1] = pole_2[r][1] * 2;
                                    pole_2[r][2] = 0;
                                }
                                if (pole_2[r][2] && (pole_2[r][2] == pole_2[r][3])) {
                                    if (pole_2[r][2] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[r][2] = pole_2[r][2] * 2;
                                    pole_2[r][3] = 0;
                                }
                                if (pole_2[r][3] && (pole_2[r][3] == pole_2[r][4])) {
                                    if (pole_2[r][3] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[r][3] = pole_2[r][3] * 2;
                                    pole_2[r][4] = 0;
                                }
                                if (pole_2[r][4] && (pole_2[r][4] == pole_2[r][5])) {
                                    if (pole_2[r][4] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[r][4] = pole_2[r][4] * 2;
                                    pole_2[r][5] = 0;
                                }
                                if (pole_2[r][5] && (pole_2[r][5] == pole_2[r][6])) {
                                    if (pole_2[r][5] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[r][5] = pole_2[r][5] * 2;
                                    pole_2[r][6] = 0;
                                }
                                if (pole_2[r][6] && (pole_2[r][6] == pole_2[r][7])) {
                                    if (pole_2[r][6] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[r][6] = pole_2[r][6] * 2;
                                    pole_2[r][7] = 0;
                                }
                                if (pole_2[r][7] && (pole_2[r][7] == pole_2[r][8])) {
                                    if (pole_2[r][7] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[r][7] = pole_2[r][7] * 2;
                                    pole_2[r][8] = 0;
                                }
                                if (pole_2[r][8] && (pole_2[r][8] == pole_2[r][9])) {
                                    if (pole_2[r][8] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[r][8] = pole_2[r][8] * 2;
                                    pole_2[r][9] = 0;
                                }
                                if (pole_2[r][9] && (pole_2[r][9] == pole_2[r][10])) {
                                    if (pole_2[r][9] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[r][9] = pole_2[r][9] * 2;
                                    pole_2[r][10] = 0;
                                }
                                if (pole_2[r][10] && (pole_2[r][10] == pole_2[r][11])) {
                                    if (pole_2[r][10] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[r][10] = pole_2[r][10] * 2;
                                    pole_2[r][11] = 0;
                                }
                                ...
                                {
                                    if (pole_2[r][0] == 0){
                                        pole_2[r][0] = pole_2[r][1];
                                        pole_2[r][1] = pole_2[r][2];    
                                        pole_2[r][2] = pole_2[r][3];
                                        pole_2[r][3] = pole_2[r][4];
                                        pole_2[r][4] = pole_2[r][5];
                                        pole_2[r][5] = pole_2[r][6];
                                        pole_2[r][6] = pole_2[r][7];
                                        pole_2[r][7] = pole_2[r][8];
                                        pole_2[r][8] = pole_2[r][9];
                                        pole_2[r][9] = pole_2[r][10];
                                        pole_2[r][10] = pole_2[r][11];
                                        pole_2[r][11] = 0;
                                    } else if (pole_2[r][1] == 0) {
                                        pole_2[r][1] = pole_2[r][2];    
                                        pole_2[r][2] = pole_2[r][3];
                                        pole_2[r][3] = pole_2[r][4];
                                        pole_2[r][4] = pole_2[r][5];
                                        ...
                                        pole_2[r][10] = pole_2[r][11];
                                        pole_2[r][11] = 0;
                                    } else if (pole_2[r][7] == 0) {
                                        pole_2[r][7] = pole_2[r][8];
                                        pole_2[r][8] = pole_2[r][9];
                                        pole_2[r][9] = pole_2[r][10];
                                        pole_2[r][10] = pole_2[r][11];
                                        pole_2[r][11] = 0;
                                    } else if (pole_2[r][8] == 0) {
                                        pole_2[r][8] = pole_2[r][9];
                                        pole_2[r][9] = pole_2[r][10];
                                        pole_2[r][10] = pole_2[r][11];
                                        pole_2[r][11] = 0;
                                    } else if (pole_2[r][9] == 0) {
                                        pole_2[r][9] = pole_2[r][10];
                                        pole_2[r][10] = pole_2[r][11];
                                        pole_2[r][11] = 0;
                                    } else if (pole_2[r][10] == 0) {
                                        pole_2[r][10] = pole_2[r][11];
                                        pole_2[r][11] = 0;
                                    }
                                }                            
                            }
                            if(pole_2[0][0] && pole_2[0][1] && pole_2[0][2] && pole_2[0][3] && pole_2[0][4] && pole_2[0][5] && pole_2[0][6] && pole_2[0][7] && pole_2[0][8] && pole_2[0][9] && pole_2[0][10] && pole_2[0][11] && pole_2[1][0] && pole_2[1][1] && pole_2[1][2] && pole_2[1][3] && pole_2[1][4] && pole_2[1][5] && pole_2[1][6] && pole_2[1][7] && pole_2[1][8] && pole_2[1][9] && pole_2[1][10] && pole_2[1][11] && pole_2[2][0] && pole_2[2][1] && pole_2[2][2] && pole_2[2][3] && pole_2[2][4] && pole_2[2][5] && pole_2[2][6] && pole_2[2][7] && pole_2[2][7] && pole_2[2][8] && pole_2[2][9] && pole_2[2][10] && pole_2[2][11] && pole_2[3][0] && pole_2[3][1] && pole_2[3][2] && pole_2[3][3] && pole_2[3][4] && pole_2[3][5] && pole_2[3][6] && pole_2[3][7] && pole_2[3][8] && pole_2[3][9] && pole_2[3][10] && pole_2[3][11] && pole_2[4][0] && pole_2[4][1] && pole_2[4][2] && pole_2[4][3] && pole_2[4][4] && pole_2[4][5] && pole_2[4][6] && pole_2[4][7] && pole_2[4][8] && pole_2[4][9] && pole_2[4][10] && pole_2[4][11] && pole_2[5][0] && pole_2[5][1] && pole_2[5][2] && pole_2[5][3] && pole_2[5][4] && pole_2[5][5] && pole_2[5][6] && pole_2[5][7] && pole_2[5][8] && pole_2[5][9] && pole_2[5][10] && pole_2[5][11] && pole_2[6][0] && pole_2[6][1] && pole_2[6][2] && pole_2[6][3] && pole_2[6][4] && pole_2[6][5] && pole_2[6][6] && pole_2[6][7] && pole_2[6][8] && pole_2[6][9] && pole_2[6][10] && pole_2[6][11] && pole_2[7][0] && pole_2[7][1] && pole_2[7][2] && pole_2[7][3] && pole_2[7][4] && pole_2[7][5] && pole_2[7][6] && pole_2[7][0] && pole_2[7][8] && pole_2[7][9] && pole_2[7][10] && pole_2[7][11]) {
                                game_over = true;
                                game = false;                            
                                break;
                            }
                            int new_x = rand() % 8;
                            int new_y = rand() % 12;
                            while (pole_2[new_x][new_y] != 0) {
                                new_x = rand() % 8;
                                new_y = rand() % 12;
                            }
                            if (rand() % 2 == 1) {
                                pole_2[new_x][new_y] = 2;
                            } else {
                                pole_2[new_x][new_y] = 4;
                            }
                        } else if (game_mode == 3) {
                            for (int r = 0; r < 3; r++)
                            {
                                if (pole_3[r][0] && (pole_3[r][0] == pole_3[r][1])){
                                    if (pole_3[r][0]*2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }                                    
                                    pole_3[r][0] = pole_3[r][0]*2;
                                    pole_3[r][1] = 0;
                                }
                                if (pole_3[r][1] && (pole_3[r][1] == pole_3[r][2])) {
                                    if (pole_3[r][1] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_3[r][1] = pole_3[r][1] * 2;
                                    pole_3[r][2] = 0;
                                }                               
                                ...
                                {
                                    if (pole_3[r][0] == 0){
                                        pole_3[r][0] = pole_3[r][1];
                                        pole_3[r][1] = pole_3[r][2];    
                                        pole_3[r][2] = 0;                                        
                                    }
                                    else if (pole_3[r][1] == 0 && pole_3[r][2]) {
                                        pole_3[r][1] = pole_3[r][2];    
                                        pole_3[r][2] = 0;
                                    }
                                }                            
                            }
                            if(pole_3[0][0] && pole_3[0][1] && pole_3[0][2] && pole_3[1][0] && pole_3[1][1] && pole_3[1][2] && pole_3[2][0] && pole_3[2][1] && pole_3[2][2]) {
                                game_over = true;
                                game = false;                            
                                break;
                            }
                            int new_x = rand() % 3;
                            int new_y = rand() % 3;
                            while (pole_3[new_x][new_y] != 0) {
                                new_x = rand() % 3;
                                new_y = rand() % 3;
                            }
                            if (rand() % 2 == 1) {
                                pole_3[new_x][new_y] = 2;
                            } else {
                                pole_3[new_x][new_y] = 4;
                            }
                        }
                        break;
                    case SDLK_RIGHT:                              
                        if (game_mode == 1) {
                            ...
                            {
                                if (pole_2[r][10] && (pole_2[r][10] == pole_2[r][11])) {
                                    if (pole_2[r][11] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[r][11] = pole_2[r][11] * 2;
                                    pole_2[r][10] = 0;
                                } 
                                if (pole_2[r][9] && (pole_2[r][9] == pole_2[r][10])) {
                                    if (pole_2[r][10] * 2 == 2048) {
                                ...
                                {
                                    if (pole_2[r][11] == 0){                                        
                                        pole_2[r][11] = pole_2[r][10];
                                        pole_2[r][10] = pole_2[r][9];
                                        pole_2[r][9] = pole_2[r][8];
                                        pole_2[r][8] = pole_2[r][7];
                                        pole_2[r][7] = pole_2[r][6];
                                        pole_2[r][6] = pole_2[r][5];
                                        pole_2[r][5] = pole_2[r][4];
                                        pole_2[r][4] = pole_2[r][3];
                                        pole_2[r][3] = pole_2[r][2];
                                        pole_2[r][2] = pole_2[r][1];    
                                        pole_2[r][1] = pole_2[r][0];
                                        pole_2[r][0] = 0;
                                    }
                                    else if (pole_2[r][10] == 0){
                                        pole_2[r][10] = pole_2[r][9];
                            ...
                            {    
                                if (pole_3[r][1] && (pole_3[r][1] == pole_3[r][2])) {
                                    if (pole_3[r][2] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_3[r][2] = pole_3[r][2] * 2;
                                    pole_3[r][1] = 0;
                                }       
                                if (pole_3[r][0] && (pole_3[r][0] == pole_3[r][1])){
                                    if (pole_3[r][1]*2 == 2048) {
                                ...
                                {
                                    if (pole_3[r][2] == 0) {
                                        pole_3[r][2] = pole_3[r][1];    
                                        pole_3[r][1] = pole_3[r][0];
                                        pole_3[r][0] = 0;
                                    }  
                                    else if (pole_3[r][1] == 0) {
                                        pole_3[r][1] = pole_3[r][0]; 
                                        pole_3[r][0] = 0;  
                                    }
                                }
                    ...
                    case SDLK_DOWN:                        
                        if (game_mode == 1) {
                            ...
                            for (int r = 0; r < 12; r++)
                            {
                                if (pole_2[11][r] && (pole_2[11][r] == pole_2[10][r])) {
                                    if (pole_2[11][r] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[11][r] = pole_2[11][r] * 2;
                                    pole_2[10][r] = 0;
                                }
                                if (pole_2[10][r] && (pole_2[10][r] == pole_2[9][r])) {
                                    if (pole_2[10][r] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[10][r] = pole_2[10][r] * 2;
                                    pole_2[9][r] = 0;
                                }
                                if (pole_2[9][r] && (pole_2[9][r] == pole_2[8][r])) {
                                    if (pole_2[9][r] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[9][r] = pole_2[9][r] * 2;
                                    pole_2[8][r] = 0;
                                }
                                if (pole_2[8][r] && (pole_2[8][r] == pole_2[9][r])) {
                                    if (pole_2[9][r] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                ...
                                if (pole_2[7][r] && (pole_2[7][r] == pole_2[8][r])) {
                                    if (pole_2[8][r] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[8][r] = pole_2[8][r] * 2;
                                    pole_2[7][r] = 0;
                                }
                                if (pole_2[6][r] && (pole_2[6][r] == pole_2[7][r])) {
                                    if (pole_2[7][r] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[7][r] = pole_2[7][r] * 2;
                                    pole_2[6][r] = 0;
                                }
                                if (pole_2[5][r] && (pole_2[5][r] == pole_2[6][r])) {
                                    if (pole_2[6][r] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[6][r] = pole_2[6][r] * 2;
                                    pole_2[5][r] = 0;
                                }
                                if (pole_2[4][r] && (pole_2[4][r] == pole_2[5][r])) {
                                    if (pole_2[5][r] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[5][r] = pole_2[5][r] * 2;
                                    pole_2[4][r] = 0;
                                }
                                if (pole_2[3][r] && (pole_2[3][r] == pole_2[4][r])) {
                                    if (pole_2[4][r] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[4][r] = pole_2[4][r] * 2;
                                    pole_2[3][r] = 0;
                                }
                               if (pole_2[2][r] && (pole_2[2][r] == pole_2[3][r])) {
                                    if (pole_2[3][r] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[3][r] = pole_2[3][r] * 2;
                                    pole_2[2][r] = 0;
                                }     
                                if (pole_2[1][r] && (pole_2[1][r] == pole_2[2][r])) {
                                    if (pole_2[2][r] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_2[2][r] = pole_2[2][r] * 2;
                                    pole_2[1][r] = 0;
                                }       
                                if (pole_2[0][r] && (pole_2[0][r] == pole_2[1][r])){
                                    if (pole_2[1][r]*2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }                                
                                    pole_2[1][r] = pole_2[1][r]*2;
                                    pole_2[0][r] = 0;
                                }                    
                                ...
                                {
                                    if (pole_2[11][r] == 0){
                                        pole_2[11][r] = pole_2[10][r];
                                        pole_2[10][r] = pole_2[9][r];
                                        pole_2[9][r] = pole_2[8][r];
                                        pole_2[8][r] = pole_2[7][r];
                                        pole_2[7][r] = pole_2[6][r];
                                        pole_2[6][r] = pole_2[5][r];
                                        pole_2[5][r] = pole_2[4][r];
                                        pole_2[4][r] = pole_2[3][r];
                                        pole_2[3][r] = pole_2[2][r];
                                        pole_2[2][r] = pole_2[1][r];    
                                        pole_2[1][r] = pole_2[0][r];
                                        pole_2[0][r] = 0;
                                    }
                                    else if (pole_2[10][r] == 0){
                                        pole_2[10][r] = pole_2[9][r];
                                        pole_2[9][r] = pole_2[8][r];
                                        pole_2[8][r] = pole_2[7][r];
                                        pole_2[7][r] = pole_2[6][r];
                                    ...
                                    else if (pole_2[3][r] == 0){
                                        pole_2[3][r] = pole_2[2][r];
                                        pole_2[2][r] = pole_2[1][r];    
                                        pole_2[1][r] = pole_2[0][r];
                                        pole_2[0][r] = 0;
                                    }
                                    else if (pole_2[2][r] == 0) {
                                        pole_2[2][r] = pole_2[1][r];    
                                        pole_2[1][r] = pole_2[0][r];
                                        pole_2[0][r] = 0;
                                    }  
                                    else if (pole_2[1][r] == 0) {
                                        pole_2[1][r] = pole_2[0][r]; 
                                        pole_2[0][r] = 0;  
                                    }
                                }
                            ...
                            for (int r = 0; r < 3; r++)
                            {    
                                if (pole_3[1][r] && (pole_3[1][r] == pole_3[2][r])) {
                                    if (pole_3[2][r] * 2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }
                                    pole_3[2][r] = pole_3[2][r] * 2;
                                    pole_3[1][r] = 0;
                                }       
                                if (pole_3[0][r] && (pole_3[0][r] == pole_3[1][r])){
                                    if (pole_3[1][r]*2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }                                
                                    pole_3[1][r] = pole_3[1][r]*2;
                                    pole_3[0][r] = 0;
                                }                    
                                ...
                                {
                                    if (pole_3[2][r] == 0) {
                                        pole_3[2][r] = pole_3[1][r];    
                                        pole_3[1][r] = pole_3[0][r];
                                        pole_3[0][r] = 0;
                                    }  
                                    else if (pole_3[1][r] == 0) {
                                        pole_3[1][r] = pole_3[0][r]; 
                                        pole_3[0][r] = 0;  
                                    }
                                }
                    ...
                    case SDLK_UP:
                        if (game_mode == 1) {
                            ...
                            {
                                if (pole_2[0][r] && (pole_2[0][r] == pole_2[1][r])){
                                    if (pole_2[0][r]*2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }                                    
                                    pole_2[0][r] = pole_2[0][r]*2;
                                    pole_2[1][r] = 0;
                                }
                                if (pole_2[1][r] && (pole_2[1][r] == pole_2[2][r])) {
                                    if (pole_2[1][r] * 2 == 2048) {
                                ...
                                {
                                    if (pole_2[0][r] == 0){
                                        pole_2[0][r] = pole_2[1][r];
                                        pole_2[1][r] = pole_2[2][r];    
                                        pole_2[2][r] = pole_2[3][r];
                                        pole_2[3][r] = pole_2[4][r];
                                        pole_2[4][r] = pole_2[5][r];
                                        pole_2[5][r] = pole_2[6][r];
                                        pole_2[6][r] = pole_2[7][r];
                                        pole_2[7][r] = 0;
                                    }
                                    else if (pole_2[1][r] == 0) {
                                        pole_2[1][r] = pole_2[2][r];    
                            ...
                            {
                                if (pole_3[0][r] && (pole_3[0][r] == pole_3[1][r])){
                                    if (pole_3[0][r]*2 == 2048) {
                                        win = true;
                                        game = false;
                                        break;
                                    }                                    
                                    pole_3[0][r] = pole_3[0][r]*2;
                                    pole_3[1][r] = 0;
                                }
                                if (pole_3[1][r] && (pole_3[1][r] == pole_3[2][r])) {
                                    if (pole_3[1][r] * 2 == 2048) {
                                ...
                                {
                                    if (pole_3[0][r] == 0){
                                        pole_3[0][r] = pole_3[1][r];
                                        pole_3[1][r] = pole_3[2][r];    
                                        pole_3[2][r] = 0;                                        
                                    }
                                    else if (pole_3[1][r] == 0 && pole_3[2][r]) {
                                        pole_3[1][r] = pole_3[2][r];    
                                        pole_3[2][r] = 0;                                        
                                    }
                                }
        ...
        if (!game && !game_over && !win) {
            ...
            //Musíme si udělt surface - vyrobíme obrázek, který bude v paměti, z toho potom 
            SDL_Rect score_rect = {.x = WINDOW_WIDTH / 2 - 50, .y = 50, .w = 130, .h = 20}; //V tomto obdélníku bude to score
